...
/** Input port — suspends, unsuspends, or resets progress on a Card. */
public interface UpdateCardUseCase {
   ...
   * @param cardId id of the Card to update (non-null)
   * @param suspended new suspended state (non-null)
   */
  record Command(OwnerId ownerId, CardId cardId, boolean suspended) {
